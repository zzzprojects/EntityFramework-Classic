...
namespace System.Data.Entity.ConnectionFactoryConfig
{
...
#if NETSTANDARD
    extern alias efpowershell;
    using psres = efpowershell::System.Data.Entity.Migrations.Resources;
#endif
    ...
    public class ConnectionFactoryConfigTests : TestBase
    {
        ...
        private static readonly Version _net45EntityFrameworkVersion = new Version("7.0.0.0");
        private static readonly Version _net40EntityFrameworkVersion = new Version("7.0.0.0");

        private const string EntityFrameworkSectionFormat =
            "System.Data.Entity.Internal.ConfigFile.EntityFrameworkSection, Z.EntityFramework.Classic, Version={0}, Culture=neutral, PublicKeyToken=afc61983f100d280";
...
#if NETSTANDARD
                            Assert.Equal(
                                psres.Strings.SaveConnectionFactoryInConfigFailed(
