...
namespace System.Data.Entity
{
    ...
    public static class ResourceUtilities
    {
            ...
            params string[] names)
        {
            ...
            {
                // TODO: ZZZ- Find a better way for this hack
                if (prefix == "FunctionalTests.ProductivityApi.SpatialTvfsModel.")
                {
                    prefix = "System.Data.Entity.TestModels.SpatialTvfsModel.";
                }
