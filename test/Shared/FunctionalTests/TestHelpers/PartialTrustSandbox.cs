...
namespace System.Data.Entity
{
    ...
    {
        // TODO: ZZZ - Do we really need reflection? Some test doesn't work otherwise... probably keep it
#if NETSTANDARD
        private static readonly PartialTrustSandbox _default = new PartialTrustSandbox("Default Partial Trust Sandbox", true);
#else
