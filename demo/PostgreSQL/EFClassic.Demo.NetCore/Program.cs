...
namespace EFClassic.Demo.NetCore
{
    internal class Program
	{
		public static string ConnectionString = "Server=localhost;Port=5432;Database=EFClassic_Demo_NetCore;User Id=[User Id]; Password=[Password]";
