...
namespace System.Data.Entity.Core.Objects
{
    ...
    public sealed class ObjectContextOptions
    {
        ...
        /// <summary>The lazy query result filter configuration.</summary>
        internal Lazy<QueryResultFilterManager> _queryResultFilterConfiguration = new Lazy<QueryResultFilterManager>(() => new QueryResultFilterManager());

        /// <summary>Get the query result filter configuration.</summary>
        /// <value>The query result filter configuration.</value>
        public QueryResultFilterManager QueryResultFilterConfiguration => _queryResultFilterConfiguration.Value;
