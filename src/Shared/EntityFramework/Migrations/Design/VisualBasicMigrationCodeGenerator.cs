...
namespace System.Data.Entity.Migrations.Design
{
    ...
    public class VisualBasicMigrationCodeGenerator : MigrationCodeGenerator
    {
        ...
        private static bool IsVbKeyword(string name)
        {
            ...
            return group.Any(k => string.Equals(k, name, StringComparison.OrdinalIgnoreCase));
        }

        // Source: https://referencesource.microsoft.com/#System/compmod/microsoft/visualbasic/VBCodeProvider.cs
