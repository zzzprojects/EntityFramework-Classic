...
namespace System.Data.Entity.Migrations.Utilities
{
    ...
    internal class ConfigurationFileUpdater
    {
            ...
            _dependentAssemblyElement
                = new XElement(
                    ...
                    new XElement(
                        ...
                        new XAttribute("name", "Z.EntityFramework.Classic"),
                        new XAttribute("culture", "neutral"),
                        new XAttribute("publicKeyToken", "afc61983f100d280")),
                    new XElement(
                        _asm + "codeBase",
        ...
        // <summary>
        // Updates a config file by adding binding redirects for Z.EntityFramework.Classic.dll.
