        ...
        public override TypeUsage GetStoreType(TypeUsage edmType)
        {
            ...
            switch (primitiveType.PrimitiveTypeKind)
            {
                ...
                case PrimitiveTypeKind.DateTime:
                    return EntityFrameworkManager.SqlServer.BackwardCompatibility.UseDateTime2 ?
                        TypeUsage.CreateDefaultTypeUsage(StoreTypeNameToStorePrimitiveType["datetime2"]):
                        TypeUsage.CreateDefaultTypeUsage(StoreTypeNameToStorePrimitiveType["datetime"]);
